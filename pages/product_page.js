    ...
    return(
        ...
        <center className="mt-20">
            <div className="row container mt-5">
                <div className="col">
                    <img className="ctnGambar" src="/products/prod_big.png"></img>
                    <div className="row">
                        <img className="col ctnGambarKecil" src="/products/small1.png"></img>
                        <img className="col ctnGambarKecil" src="/products/small2.jpg"></img>
                        <img className="col ctnGambarKecil" src="/products/small3.jpg"></img>
                    </div>
                </div>
